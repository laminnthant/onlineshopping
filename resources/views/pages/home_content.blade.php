            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{URL::to($product->product_image)}}" height=" 200px" alt="" />
                            <h4>{{$product->product_price}} <span>Kyats</span></h4>
                        ...
                        <!-- <div class="product-overlay">
                            <div class="overlay-content">
                                ...
                                <a href="{{url('/view-product/'.$product->product_id)}}"><p>{{$product->product_name}}</p></a>
                                <a href="{{url('/view-product/'.$product->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                            </div>
                        </div> -->
                </div>
