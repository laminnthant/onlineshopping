		...
		<div class="container">
			<div class="row">
              ...
              <input type="email" placeholder="Email" name="customer_email" required="" />
							...
							<button type="submit" class="btn btn-default" style="background-color:#03c2fc">Login</button>
						</form>
					</div><!--/login form-->
				</div>
				<div class="col-sm-1">
					<h2 class="or" style="background-color:#03c2fc">OR</h2>
				</div>
				<div class="col-sm-4">
              ...
              <input type="text" placeholder="Mobile Number" name="mobile_number" required="" />
							<button type="submit" class="btn btn-default" style="background-color:#03c2fc">Signup</button>
						</form>
					</div><!--/sign up form-->
				</div>
			</div>
